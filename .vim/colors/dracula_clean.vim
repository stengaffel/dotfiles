...
call s:hi('ColorColumn', 'NONE', 'GREY30', 'NONE', 'NONE', 'NONE')
call s:hi('Todo', 'BLACK', s:yellow, 'NONE', 'NONE', 'NONE')
call s:hi('WildMenu', 'BLACK', s:purple, 'NONE', 'NONE', 'NONE')
call s:hi('TabLineFill', s:current_line_color, s:current_line_color, 'NONE', 'NONE', 'NONE')
...
call s:hi('Search', 'BLACK', s:yellow, 'NONE', 'NONE', 'NONE')
